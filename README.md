...
```
cd existing_repo
git remote add origin https://gitlab-new.onjoyride.com/jrx/super-champs-token.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.onjoyride.com/jrx/super-champs-token/-/settings/integrations)
