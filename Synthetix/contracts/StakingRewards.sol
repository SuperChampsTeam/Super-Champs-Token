...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    ...
    function notifyRewardAmount(uint256 reward) external override(IStakingRewards, RewardsDistributionRecipient) virtual onlyRewardsDistribution updateReward(address(0)) {
